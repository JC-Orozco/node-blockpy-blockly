...
gulp.task('blockly', function() {
  return gulp.src('../blockpy/blockly/blockly_compressed.js')
...
gulp.task('blocks', function() {
  return gulp.src('../blockpy/blockly/blocks_compressed.js')
      .pipe(insert.wrap(`
...
gulp.task('js', function() {
  return gulp.src('../blockpy/blockly/javascript_compressed.js')
      .pipe(insert.wrap('module.exports = function(Blockly){', 'return Blockly.JavaScript;}'))
      .pipe(gulp.dest('lib'))
});

gulp.task('dart', function() {
  return gulp.src('../blockpy/blockly/dart_compressed.js')
